...
import com.lifestyle.DAO.CVSManager;
import com.lifestyle.DAO.DAOCardio;
import com.lifestyle.DAO.DAOFonte;
import com.lifestyle.DAO.DAOMachine;
import com.lifestyle.DAO.DAOProfil;
import com.lifestyle.DAO.DatabaseHelper;
import com.lifestyle.DAO.Fonte;
import com.lifestyle.DAO.Machine;
import com.lifestyle.DAO.Profile;
import com.lifestyle.DAO.cardio.DAOOldCardio;
import com.lifestyle.DAO.cardio.OldCardio;
import com.lifestyle.bodymeasures.BodyPartListFragment;
import com.lifestyle.fonte.FontesPagerFragment;
import com.lifestyle.intro.MainIntroActivity;
import com.lifestyle.machines.MachineFragment;
import com.lifestyle.utils.CustomExceptionHandler;
import com.lifestyle.utils.FileChooserDialog;
import com.lifestyle.utils.ImageUtil;
import com.lifestyle.utils.MusicController;
...
//    private Context context = MainActivity.this;
    ...
    /**
     * This the Activity you get When you open app
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!utils.getStoredString(MainActivity.this, "date").equals(utils.getDate())) {
        ...
        /** Saving states here if not saved*/
        ...
        if (DatabaseHelper.DATABASE_VERSION >= 15 && !mMigrationBD15done) {
            ...
            if (mDbOldCardio.tableExists()) {
                ...
                List<OldCardio> mList = mDbOldCardio.getAllRecords(); // Getting all records
                ...
                for (Machine record : machineList) {
                    ...
                    // Reset all the fields on machines.
                }
            }
        ...
        if (folder.exists()) {
            if (!(Thread.getDefaultUncaughtExceptionHandler() instanceof CustomExceptionHandler)) { // Handle exception
    ...
    private void savePhotoProfile(String path) {
        ...
        // Save the photo path on the profile.
    ...
    public void onBackPressed() {
        ...
        if (index >= 0) {
            ...
            // If we are the root, with we must click twice
            ...
            TextView quoteText = dialog.findViewById(R.id.quoteTextView);
            TextView authorText = dialog.findViewById(R.id.authorTextView);

            quoteText.setText(utils.getStoredString(MainActivity.this, "quote"));
            authorText.setText(utils.getStoredString(MainActivity.this, "author"));
            ...
            dialog.findViewById(R.id.exitBtn).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    // CODE HERE
                    dialog.dismiss();
...
//                    authorStr = o.getString(1);
                    ...
                    utils.storeString(MainActivity.this, "date", utils.getDate());
                    utils.storeString(MainActivity.this, "quote", quoteStr);
                    utils.storeString(MainActivity.this, "author", authorStr);
...
//            Toast.makeText(MainActivity.this, quoteStr + "\n\n" + authorStr, Toast.LENGTH_SHORT).show();
