...
import com.lifestyle.utils.RealPathUtil;
...
public class MachineDetailsFragment extends Fragment {
    ...
    private boolean CreateMuscleDialog() {
        if (isCreateMuscleDialogActive)
            return true; // If the dialog box is already active, then do not create a second one.
        ...
        newProfilBuilder.setPositiveButton(getResources().getString(R.string.global_ok), (dialog, whichButton) -> {
            ...
            // If we have at least selected a muscle
        ...
        switch (requestCode) {
            ...
            case CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    // The file is created in the cache.


                    // Move the file to the FastNFitness directory
