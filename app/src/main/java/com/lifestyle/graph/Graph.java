...
public class Graph {
    ...
    public void draw(ArrayList<Entry> entries) {
        ...
        mChart.invalidate();
        //mChart.animateY(500, Easing.EasingOption.EaseInBack)
        // ;    //refresh graph
        ...
        switch (z) {
            ...
            case ZOOM_MONTH:
                ...
                if (mChart.getData() != null) {
                    ...
                    // allow 30 values to be displayed at once on the x-axis, not more
            ...
            case ZOOM_YEAR:
                ...
                if (mChart.getData() != null) {
                    ...
                    // allow 365 values to be displayed at once on the x-axis, not more
