package com.lifestyle.DAO.cardio;
...
import com.lifestyle.DAO.DAOBase;
import com.lifestyle.DAO.DAOProfil;
import com.lifestyle.DAO.DAOUtils;
    ...
    private List<OldCardio> getRecordsList(String pRequest) {
        ...
        if (mCursor.moveToFirst()) {
            do {
                ...
                Profile lProfile = lDAOProfil.getProfil(mCursor.getLong(mCursor
                    .getColumnIndex(DAOOldCardio.PROFIL_KEY)));
                ...
                value.setId(Long.parseLong(mCursor.getString(mCursor
                    .getColumnIndex(DAOOldCardio.KEY))));
